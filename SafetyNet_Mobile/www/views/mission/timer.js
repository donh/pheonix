var timerModule = angular.module('timer', ['ionic'])
  .directive('timer', ['$compile', function ($compile) {
    return  {
      ...
      controller: ['$scope', '$element', '$attrs', '$timeout', '$ionicPopup', function ($scope, $element, $attrs, $timeout, $ionicPopup) {
